	...
	var MyController = {
		...
		renderTable: function() {
            return $table.render({
                elem: '#rank-list'
                ,height: 'full-100'
                ,url: rankApi.getUrl('queryMonth').url
				,method: 'post'
                ,page: true //开启分页
        ...
        view: function(rowdata) {
            var url = request.composeUrl("http://test.youguu.com/mobile/simtrade-tiancheng/html/otherMatchTradeHome.html?matchId=1131&toUid=20");
