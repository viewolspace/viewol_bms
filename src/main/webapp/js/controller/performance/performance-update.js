...
layui.use(requireModules, function (form,
    ...
    if(!$.isEmptyObject(param)) {
        setAdPosition(param.adPositon);
        param.adMethod = param.adMethod.split(",");//将数组合并成字符串
        formUtil.renderData($('#performance-form'), param);
    }
    ...
    f.on('submit(performance-form)', function (data) {
        ...
        ajax.request(performanceApi.getUrl('updatePerformance'), data.field, function () {
